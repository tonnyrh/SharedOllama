---
name: ollama-worker
description: Delegate small, bounded coding and editing tasks to the local Ollama/Qwen worker via SharedOllama. Use for one-file changes, one function or method, targeted refactors, focused tests, small scripts, regex, documentation edits, and FILE_OP-based patch generation in Cursor. Read the canonical skill in ../../../skills/ollama-worker before invoking scripts.
---
...
- [../../../skills/ollama-worker/scripts/check_ollama.py](../../../skills/ollama-worker/scripts/check_ollama.py)
